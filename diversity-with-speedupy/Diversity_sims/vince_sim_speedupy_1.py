import sys
sys.path.append('/home/joaopedrolopez/Downloads/AvaliacaoExperimental/Experimentos/diversity-with-speedupy/Diversity_sims')
...
if __name__ == '__main__':
    ...
    @initialize_speedupy
    def main():
        x = repeat_mutation_sim(1000000.0, 12162, 156)
        t1 = dt.datetime.now()
