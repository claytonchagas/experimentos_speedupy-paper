...
ORIGEM="$ROOT_PATH/exps_functools/dnacc/dnacc"
DESTINO="$ROOT_PATH/exps_functools/dnacc/basic_spheres"
DESTINO2="$ROOT_PATH/exps_functools/dnacc/walking_colloid"
